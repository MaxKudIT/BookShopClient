        ...
        <>
            ...
            <div className={styles.recomm_page_style_inc}>
                ...
                <div className={styles.recomm_main_container}>
                    <RecommsRowWithDynamic color='purple' icon={BsMagic} title='Персонально для вас' description='На основе ваших интересов и недавних покупок' books={[]} />

                    <RecommsRowWithDynamic color='pink' icon={AiOutlineRise} title='Сейчас в тренде' description='Книги, которые обсуждают все прямо сейчас' books={[]} />

                    <RecommsRowWithDynamic color='blue' icon={RiTimerFlashLine} title='Свежие поступления' description='Только что из печати, специально для нашей библиотеки' books={[]} />
